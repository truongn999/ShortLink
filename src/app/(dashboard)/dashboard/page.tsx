...
export default function Dashboard() {
  ...
  const [chartData, setChartData] = useState<{ dateKey: string; name: string; clicks: number }[]>([]);
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const formattedChartData: { dateKey: string; name: string; clicks: number }[] = [];
    ...
    <div className="animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-6">
            ...
            <button onClick={() => router.push('/links')} className="w-full mt-4 text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors py-2 border-t border-neutral-200 dark:border-neutral-700">Xem tất cả</button>
        </div>
      </div>
