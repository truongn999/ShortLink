...
export default function Links() {
  ...
  // Host state for client-side access
                    ...
                    <div className="flex items-center gap-2">
                            ...
                            <div>
                                <div className="text-base font-semibold text-neutral-900 dark:text-white flex items-center gap-2">
                                    {link.short_code}
                                    <a href={`http://${host}/${link.short_code}`} target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400">
